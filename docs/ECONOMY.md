...
Co-op requires server 0.3.0 or later. With an older server the shop explains that an update is needed; it does not simulate local coin awards or modify remote combat.
