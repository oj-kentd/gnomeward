...
export async function startServer(config = readConfig(), roomOptions = {}) {
  ...
  const gameServer = new Server({
    ...
    express: app => {
      ...
      app.get('/healthz', (_req, res) => res.json({ status: 'ok', service: 'gnomeward-server', version: SERVER_VERSION, protocol: PROTOCOL_VERSION, costumeVersion: 1, tumbleSpeedVersion: 1, fusionVersion: 1 }));
