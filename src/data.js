...
export const NECRO_PATH_SECRET = {
  id: 'necro-echoes', mapId: 'hollow', requiredKills: 10,
  order: ['hollow-flame', 'hollow-leaf', 'hollow-star', 'hollow-moon'],
};

const path = (id, name, description, costs = [10, 24, 48], finalTierHint) => ({ id, name, description, costs, finalTierHint });
export const TOWERS = {
  ...
  spore: { id: 'spore', name: 'Morel', role: 'Poison gardener', description: 'Plants mushrooms on the trail. Passing skeletons catch a lingering poison.', cost: 160, color: '#a589d5', unlockWave: 0, paths: [path('venom','Potent Spores','Increase poison damage each second.',undefined,'Sporefire: pair tier 3 with Wild Garden 3 and Bramble’s Big Bang 3.'),path('duration','Deep Roots','Poison lasts longer; mushrooms can affect more skeletons.'),path('speed','Fast Harvest','Plant mushrooms more often.'),path('range','Wild Garden','Plant farther away. Tier 1 lets poisoned skeletons infect nearby enemies once per second; higher tiers spread farther and infect more targets. Secondary infections do not spread.',undefined,'Sporefire: pair tier 3 with Potent Spores 3 and Bramble’s Big Bang 3.')] },
  boom: { id: 'boom', name: 'Bramble', role: 'Chain-reaction expert', description: 'Defeated skeletons burst into sparks, damaging their nearby friends.', cost: 210, color: '#e5a742', unlockWave: 0, paths: [path('power','Heavy Acorns','Increase the damage of direct attacks.'),path('blast','Big Bang','Bigger and stronger on-kill explosions.',undefined,'Sporefire: tier 3 ignites poison from a Morel with Potent Spores 3 + Wild Garden 3.'),path('speed','Quick Fuse','Fire acorns more often.'),path('range','Long Toss','Increase attack range.')] },
  ...
  multi: { id: 'multi', name: 'Tumble', role: 'Many little surprises', description: 'Attacks several skeletons at once. One special path improves damage, speed, and target count. Clear wave 15 to unlock.', cost: 290, color: '#64b7bb', unlockWave: 15, paths: [path('flurry','Whirling Wonders','More targets, more damage, faster attacks.',[20,45,80],'Prismstorm: tier 3 gains crystal volleys within 7 range of Prism with Diamond Walls 3 + Shattering Light 3.')] },
