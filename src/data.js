...
export const TOWERS = {
  ...
  stun: { id: 'stun', name: 'Poppy', role: 'Bubble blaster', description: 'A pink bubble gun freezes skeletons in place for 2 seconds. Defeat the wave 10 boss to unlock.', cost: 240, color: '#ec85b4', unlockWave: 10, paths: [path('stun','Sticky Bubbles','Keep skeletons stunned for longer.'),path('speed','Bubble Stream','Shoot bubbles more often.'),path('power','Pop Power','Increase bubble damage.'),path('range','Bubble Reach','Increase attack range.')] },
