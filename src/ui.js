...
function upgradeBenefit(game, tower, index, stats) {
  ...
  const labels = [
    ...
    ['poisonDps', 'Poison/s'], ['poisonDuration', 'Poison seconds'], ['stunDuration', 'Stun seconds'],
